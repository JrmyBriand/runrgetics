...
sprint_lactic_model_optimal_params <- function(data = graubner_nixdorf_sprints,
  ...
  results <- purrr::map(events, function(i) {
    ...
    params <- fit_approx_lactic_power_params(sprint_approx_power_dist)
...
sprint_lactic_model_optimal_params_table <- function(data = graubner_nixdorf_sprints,
  ...
  table <- rename_columns(table, c(
    k1 = "k1 (s) <br> ",
    k2 = "k2 (s) <br> ",
    p_la_max = "Maximal Lactic<br> Power (W/kg)",
    event = "Event <br> "
  ))
...
sprint_lactic_model_params <- function(data = graubner_nixdorf_sprints,
  ...
  results <- purrr::map(events, function(i) {
    ...
    params <- fit_lactic_power_params(sprint_approx_power_dist)
...
sprint_lactic_model_optimal_gof_metrics <- function(data = graubner_nixdorf_sprints,
  ...
  results <- purrr::map(events, function(i) {
    ...
    gof_metrics <- fit_approx_lactic_gof_metrics(sprint_approx_power_dist)
...
sprint_lactic_model_gof_metrics <- function(data = graubner_nixdorf_sprints,
  ...
  results <- purrr::map(events, function(i) {
    ...
    gof_metrics <- fit_lactic_gof_metrics(sprint_approx_power_dist)
...
sprint_lactic_model_gof_comp_table <- function(data = graubner_nixdorf_sprints,
  ...
  # rename the columns
  table <- rename_columns(table, c(
    p_la_max_optimal = "Optimal",
    p_la_max_formalized = "Formalized",
    k1_optimal = "Optimal",
    k1_formalized = "Formalized",
    k2_optimal = "Optimal",
    k2_formalized = "Formalized",
    aic_optimal = "Optimal",
