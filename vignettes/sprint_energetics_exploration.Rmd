...
Following these assumptions, the function `sprint_approx_distribution`calculates both the acceleration and deceleration phases aprroximate distributions to provide a global approximate distribution of the energy systems to total power over the whole sprint.
...
We can compute the aprroximate energy contribution from the three metabolic pathways. 
